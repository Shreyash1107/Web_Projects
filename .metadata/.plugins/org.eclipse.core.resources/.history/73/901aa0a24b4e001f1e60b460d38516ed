        ...
        <div class="row">
            <div class="col-md-3">
                <div class="nav flex-column nav-pills menubar" id="v-pills-tab"
                    ...
                    <a class="nav-link" id="v-pills-alumni-tab" data-toggle="pill"
                        href="#v-pills-alumni" role="tab" aria-controls="v-pills-alumni"
            ...
            <div class="col-md-9 content">
                <div class="tab-content" id="v-pills-tabContent">
                    ...
                    <div class="tab-pane fade" id="v-pills-alumni" role="tabpanel"
