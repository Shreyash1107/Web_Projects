                        ...
                        <h3>Update Alumni</h3>
                            ...
                            <form name='frm' id="frm" action='update' method='GET'>
                                <div id="updateFields" style="display: none;">
                                    ...
                                    <div class="form-group mt-3">
                                        <label for="txtAlumniName">Alumni Name</label>
                                        <input type="text" name="alumniName" id="txtAlumniName" class="form-control" placeholder="Enter Alumni Name" autocomplete="off">
                                    </div>
                                    <div class="form-group">
                                        <label for="txtEmail">Alumni Email</label>
                                        <input type="email" name="email" id="txtEmail" class="form-control" placeholder="Enter Alumni Email-Id" autocomplete="off">
                                    </div>
                                    <div class="form-group">
                                        <label for="txtContact">Alumni Contact</label>
                                        <input type="text" name="contact" id="txtContact" class="form-control" placeholder="Enter Alumni Contact" autocomplete="off">
                                    </div>
                                    <div class="form-group">
                                        <label for="txtAge">Alumni Age</label>
                                        <input type="number" name="age" id="txtAge" class="form-control" placeholder="Enter Alumni Age" autocomplete="off">
                                    </div>
                                    <div class="form-group">
                                        <label for="txtCompName">Alumni Company Name</label>
                                        <input type="text" name="compname" id="txtCompName" class="form-control" placeholder="Enter Alumni Company Name" autocomplete="off">
                                    </div>
                                    <div class="form-group d-flex justify-content-center">
                                        <input type='submit' name='s' id="btn" value='Update Alumni' class="btn btn-primary" />
                                    </div>
                                </div> <!-- updateFields -->
                            </form>
                        </div> <!-- form-container -->
