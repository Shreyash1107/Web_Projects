					...
					<div class="tab-pane fade show active" id="v-pills-home"
						...
						<div class="form-container mt-5">
							...
							<form name='frm' id="frm" action='alumni' method='POST'
								...
								<div class="form-group">
									<label for="txtBatch">Alumni Contact</label> <input type="contact"
										name="Contact" id="txtBatch" class="form-control"
										placeholder="Enter Alumni Contact" onkeyup="validateBatch()"
										autocomplete="off"> <span id="s"></span>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label for="txtBatch">Alumni Company Name</label> <input type="text"
										name="compname" id="txtBatch" class="form-control"
										placeholder="Enter Alumni Company Name" onkeyup="validateBatch()"
										autocomplete="off"> <span id="s"></span>
								</div>
